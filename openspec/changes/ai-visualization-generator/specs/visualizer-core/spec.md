...
The application SHALL support opening a separate native macOS Settings window. This window SHALL be opened via the system menu bar item or a standard keyboard shortcut, leaving the main visualizer window entirely distraction-free.
